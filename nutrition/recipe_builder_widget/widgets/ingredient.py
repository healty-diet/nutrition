...
class IngredientWidget(QWidget):
    ...
    def __init__(self, food_names: List[str], on_ingredient_entered, on_ingredient_finalized):
        super().__init__()
    ...
    @Slot()
    def _ingredient_name_entered(self):
    ...
    @Slot()
    def _ingredient_mass_entered(self):
    ...
    @Slot()
    def _add_ingredient_to_recipe(self):
